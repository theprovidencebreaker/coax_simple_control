...
void CoaxSimpleControl::stabilizationControl(void) {
  ...
  */
  ...
  lqr_error[0] = lqr_error[0]*aux10;
  lqr_error[1] = lqr_error[1]*aux11;
  lqr_error[2] = lqr_error[2]*aux12;
  lqr_error[3] = lqr_error[3]*aux13;
  lqr_error[4] = lqr_error[4]*aux14;
  lqr_error[5] = lqr_error[5]*aux15;
